---
name: Bug report
about: Create a report to help improve VaultSync
title: "[Bug]"
labels: bug
...
- VaultSync Version: [e.g. 1.7.3-Beta.1]
...
If possible, attach:
- Support bundle export from Settings > Advanced
...
If the issue involves updates, include:
- Current installed version
- Target version
- Whether patch preflight was offered or blocked
- Updater diagnostics text from Settings > Advanced
