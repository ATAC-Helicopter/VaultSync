...
- [ ] `VS-1821` `P1` Finish backup and metadata orchestration decomposition
  needed for fault isolation. _(Active: scanning and deferred-hash progress now
  use focused boundaries, and repository reads are awaited; remaining hotspots
  stay open under issue #380.)_
