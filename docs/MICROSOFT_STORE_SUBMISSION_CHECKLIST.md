...
- Build the 1.8.4 Store upload package in GitHub Actions with `include_store_upload` enabled and verify the artifact shape (`.msixupload` or equivalent upload package).
